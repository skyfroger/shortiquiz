...
local loc_data = {
  en = {
    ...
    incorrectIndentationOfBlocks = "Incorrect Indentation Errors",
  ...
  ru = {
    ...
    incorrectOrderOfBlocks = "Неправильный порядок блоков",
    incorrectIndentationOfBlocks = "Неправильные отступы",
