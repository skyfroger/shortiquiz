...
The **`area`** attribute specifies the area coordinates in the format `"x y width height"`.

> **Note:** for the demo to work correctly, replace `example.assets/img.png` with the actual path to an image in your project.
